# Generated by Powerlevel10k configuration wizard on 2020-02-26 at 19:31 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_DISABLED_WORKDIR_PATTERN='/home/bmr'
  ...
  #[ nix_shell: nix shell (https://nixos.org/nixos/nix-pills/developing-with-nix-shell.html) ]# {{{1
  # Nix shell color.
  ...
  #[ aws: aws profile (https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-profiles.html) ]# {{{1
  ...
  #[ aws_eb_env: aws elastic beanstalk environment (https://aws.amazon.com/elasticbeanstalk/) ]# {{{1
  ...
  #[ google_app_cred: google application credentials (https://cloud.google.com/docs/authentication/production) ]# {{{1
