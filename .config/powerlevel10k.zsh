# Generated by Powerlevel10k configuration wizard on 2023-01-27 at 18:58 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=$([[ $TTY == /dev/tty* ]] && echo '>' || echo '❯')
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION=$([[ $TTY == /dev/tty* ]] && echo '<' || echo '❯')
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='V'
  # Prompt symbol in overwrite vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION=$([[ $TTY == /dev/tty* ]] && echo '>' || echo '❯')
  ...
  #[ direnv: direnv status (https://direnv.net/) ]# {{{1
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=3
  # Custom icon.
  # typeset -g POWERLEVEL9K_DIRENV_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ asdf: asdf version manager (https://github.com/asdf-vm/asdf) ]# {{{1
  ...
  #[ nordvpn: nordvpn connection status, linux only (https://nordvpn.com/) ]# {{{1
  ...
  #[ ranger: ranger shell (https://github.com/ranger/ranger) ]# {{{1
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=3
  # Custom icon.
  # typeset -g POWERLEVEL9K_RANGER_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ nnn: nnn shell (https://github.com/jarun/nnn) ]# {{{1
  # Nnn shell color.
  typeset -g POWERLEVEL9K_NNN_FOREGROUND=3
  # Custom icon.
  # typeset -g POWERLEVEL9K_NNN_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ xplr: xplr shell (https://github.com/sayanarijit/xplr) ]# {{{1
  # xplr shell color.
  typeset -g POWERLEVEL9K_XPLR_FOREGROUND=3
  # Custom icon.
  # typeset -g POWERLEVEL9K_XPLR_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ vim_shell: vim shell indicator (:sh) ]# {{{1
  # Vim shell indicator color.
  typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND=3
  # Custom icon.
  # typeset -g POWERLEVEL9K_VIM_SHELL_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ midnight_commander: midnight commander shell (https://midnight-commander.org/) ]# {{{1
  ...
  #[ todo: todo items (https://github.com/todotxt/todo.txt-cli) ]# {{{1
  # Todo color.
  ...
  #[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]# {{{1
  # Timewarrior color.
  ...
  #[ taskwarrior: taskwarrior task count (https://taskwarrior.org/) ]# {{{1
  # Taskwarrior color.
  ...
  #[ virtualenv: python virtual environment (https://docs.python.org/3/library/venv.html) ]# {{{1
  ...
  #[ anaconda: conda environment (https://conda.io/) ]# {{{1
  ...
  #[ pyenv: python environment (https://github.com/pyenv/pyenv) ]# {{{1
  # Pyenv color.
  ...
  #[ goenv: go environment (https://github.com/syndbg/goenv) ]# {{{1
  # Goenv color.
  ...
  #[ nodenv: node.js version from nodenv (https://github.com/nodenv/nodenv) ]# {{{1
  # Nodenv color.
  ...
  #[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]# {{{1
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=2
  # Custom icon.
  # typeset -g POWERLEVEL9K_NVM_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ nodeenv: node.js environment (https://github.com/ekalinin/nodeenv) ]# {{{1
  # Nodeenv color.
  ...
  #[ node_version: node.js version ]# {{{1
  # Node version color.
  ...
  #[ go_version: go version (https://golang.org) ]# {{{1
  # Go version color.
  ...
  #[ rust_version: rustc version (https://www.rust-lang.org) ]# {{{1
  # Rust version color.
  ...
  #[ dotnet_version: .NET version (https://dotnet.microsoft.com) ]# {{{1
  # .NET version color.
  ...
  #[ php_version: php version (https://www.php.net/) ]# {{{1
  # PHP version color.
  ...
  #[ laravel_version: laravel php framework version (https://laravel.com/) ]# {{{1
  # Laravel version color.
  typeset -g POWERLEVEL9K_LARAVEL_VERSION_FOREGROUND=1
  # Custom icon.
  # typeset -g POWERLEVEL9K_LARAVEL_VERSION_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ java_version: java version (https://www.java.com/) ]# {{{1
  # Java version color.
  ...
  #[ package: name@version from package.json (https://docs.npmjs.com/files/package.json) ]# {{{1
  # Package color.
  ...
  #[ rbenv: ruby version from rbenv (https://github.com/rbenv/rbenv) ]# {{{1
  # Rbenv color.
  ...
  #[ rvm: ruby version from rvm (https://rvm.io) ]# {{{1
  # Rvm color.
  ...
  #[ fvm: flutter version management (https://github.com/leoafarias/fvm) ]# {{{1
  # Fvm color.
  typeset -g POWERLEVEL9K_FVM_FOREGROUND=4
  # Custom icon.
  # typeset -g POWERLEVEL9K_FVM_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #[ luaenv: lua version from luaenv (https://github.com/cehoffman/luaenv) ]# {{{1
  # Lua color.
  ...
  #[ jenv: java version from jenv (https://github.com/jenv/jenv) ]# {{{1
  # Java color.
  ...
  #[ plenv: perl version from plenv (https://github.com/tokuhirom/plenv) ]# {{{1
  # Perl color.
  ...
  #[ phpenv: php version from phpenv (https://github.com/phpenv/phpenv) ]# {{{1
  # PHP color.
  ...
  #[ scalaenv: scala version from scalaenv (https://github.com/scalaenv/scalaenv) ]# {{{1
  # Scala color.
  ...
  #[ haskell_stack: haskell version from stack (https://haskellstack.org/) ]# {{{1
  # Haskell color.
  ...
  #[ kubecontext: current kubernetes context (https://kubernetes.io/) ]# {{{1
  ...
  #[ terraform: terraform workspace (https://www.terraform.io) ]# {{{1
  ...
  #[ terraform_version: terraform version (https://www.terraform.io) ]# {{{1
  ...
  #[ azure: azure account name (https://docs.microsoft.com/en-us/cli/azure) ]# {{{1
  ...
  #[ gcloud: google cloud account and project (https://cloud.google.com/) ]# {{{1
  ...
  #[ toolbox: toolbox name (https://github.com/containers/toolbox) ]# {{{1
  # Toolbox color.
  ...
  #[ vpn_ip: virtual private network indicator ]# {{{1
  # VPN IP color.
  ...
  #[ ip: ip address and bandwidth usage for a specified network interface ]# {{{1
  # IP color.
  ...
  #[ proxy: system-wide http/https/ftp proxy ]# {{{1
  # Proxy color.
