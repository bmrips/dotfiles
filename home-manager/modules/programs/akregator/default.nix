...
let
  ...
  mkFeed =
    ...
    // setIfNonNull feed.comment "@comment"
    // setIfNonNull feed.description "@description"
    // setIfNonNull feed.homepage "@htmlUrl"
    // setIfNonNull feed.loadFullWebsite "@loadLinkedWebsite"
    // setIfNonNull feed.markImmediatelyAsRead "@markImmediatelyAsRead"
    // setIfNonNull feed.notify "@useNotification";
